    ...
    >
      ...
      >
        <motion.div
          ...
          className="relative w-full bg-[#fffdfa] p-6 pb-8 sm:p-8 sm:pb-8 rounded-2xl shadow-2xl border border-rose-200/80 paper-torn flex flex-col justify-between overflow-y-auto max-h-[90vh]"
        >
          {/* Top Washi Tape */}
