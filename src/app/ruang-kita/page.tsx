    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2 border-b border-dashed border-rose-200/80 pb-5">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Link
            href="/ruang-kita"
            className={`washi-tape px-4 py-1.5 font-body font-medium text-xs sm:text-sm transition-all duration-200 rotate-[-1deg] ${
              !filter
          ...
          <Link
            ...
            className={`washi-tape px-4 py-1.5 font-body font-medium text-xs sm:text-sm transition-all duration-200 rotate-[-2deg] ${
              filter === "random"
